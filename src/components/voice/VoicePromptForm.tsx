...
export function VoicePromptForm({ formAction, currentPromptValue }: VoicePromptFormProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center space-x-3 p-3 bg-card rounded-xl shadow-md border border-border/50">
        ...
        <Input
          ...
          className="flex-grow bg-transparent border-0 focus:ring-0 text-base placeholder-muted-foreground h-10"
        />
        <SubmitButton />
      </div>
    </form>
